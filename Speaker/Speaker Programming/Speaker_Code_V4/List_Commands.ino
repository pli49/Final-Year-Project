 ...
 */
void
createNewWaveform(uint32_t waveform_initial_frequency, uint32_t waveform_final_frequency, uint32_t waveform_time, char wave_shape)
{
 ...
 */
void
displayWaveform(uint16_t identifier)
{
  ...
  Serial.print("Initial Frequency (Hz): ");
  Serial.println(getWaveformInitialFrequency(wave_to_display));
  
  Serial.print("Final Frequency (Hz): ");
 ...
 */
void
setWaveformIdentifier(waveform* wave_to_edit, uint16_t waveform_identifier)
{
